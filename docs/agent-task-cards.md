...
| OGP-SDP4 deep-space propagation | [OGP-SDP4 Propagation](../agents/tasks/ogp_sdp4_propagation.md) | [Answer](../agents/tasks/examples/ogp_sdp4_propagation_answer.md) | `agents/examples/public_agent_ogp_sdp4_propagation.yaml` |
...
| Coverage and directed link | [Coverage And Directed Link](../agents/tasks/coverage_and_directed_link.md) | [Answer](../agents/tasks/examples/coverage_and_directed_link_answer.md) | `examples/configs/public_coverage_and_link_analysis.yaml` |
