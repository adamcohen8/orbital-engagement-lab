# Flagship RIC_PD 10 km Scenario

`configs/ric_pd_10km_experiment.yaml` is the recommended review scenario after
the five-minute quickstart. It is longer than the quickstart because it exercises
a tuned RIC_PD relative-orbit controller, attitude dynamics, reaction-wheel
...
- `outputs/flagship_ric_pd_10km/rendezvous_summary.png`
- `outputs/flagship_ric_pd_10km/control_effort.png`
- `outputs/flagship_ric_pd_10km/relative_ranges.png`
- `outputs/flagship_ric_pd_10km/trajectory_ric_curv_2d_multi.png`

For the integrated orbit-attitude behavior, review:

- `outputs/flagship_ric_pd_10km/attitude_control_summary.png`
- `outputs/flagship_ric_pd_10km/chaser_thrust_alignment_error.png`
- `outputs/flagship_ric_pd_10km/chaser_attitude.png`
- `outputs/flagship_ric_pd_10km/chaser_quaternion_error.png`
...
- A tuned public `RICPDTransferController` operating on curvilinear RIC state.
