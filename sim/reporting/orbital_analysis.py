...
def _histories(context: Any) -> dict[str, AnalysisHistory]:
    ...
    for object_id, truth in dict(context.truth_hist or {}).items():
        ...
        object_attitude_enabled = attitude_enabled and str(
...
def run_scenario_orbital_analysis(*, context: Any) -> dict[str, Any]:
    ...
    for index, raw in enumerate(section.coverage):
        ...
        result["coverage"].append({
            ...
            "refinement_source": history.refinement_source, "summary": product.summary,
            "samples": [
    ...
    for index, raw in enumerate(section.directed_links):
        ...
        result["directed_links"].append({
            ...
            "refinement_source": {"tx": tx_history.refinement_source, "rx": rx_history.refinement_source},
