...
from sim.control.attitude.baseline import ReactionWheelPIDController
...
@dataclass
class RICFramePIDController(Controller):
    ...
    def act(self, belief: StateBelief, t_s: float, budget_ms: float) -> Command:
        ...
        self.pid.set_target(q_des_bn, omega_bi_des_body)
        cmd = self.pid.act(belief, t_s, budget_ms)
        mode_flags = dict(cmd.mode_flags)
        mode_flags["mode"] = "pid_ric"
