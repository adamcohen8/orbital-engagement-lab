...
_EXPORTS = {
    ...
    "ReferencePointingController": "sim.control.attitude.reference_pointing",
    "ThrustAlignController": "sim.control.attitude.reference_pointing",
    "TargetTrackController": "sim.control.attitude.reference_pointing",
    "NadirPointingController": "sim.control.attitude.reference_pointing",
    "VelocityPointingController": "sim.control.attitude.reference_pointing",
    "SunPointingController": "sim.control.attitude.reference_pointing",
    "RICAxisPointingController": "sim.control.attitude.reference_pointing",
