"""Self-contained SGP4/SDP4 analytical propagation equations for OEL.

This runtime module imports no external SGP4/SDP4 package. It is adapted from
the public Vallado SGP4/SDP4 formulation as distributed by the MIT-licensed
``python-sgp4`` project, with OEL using that external package only as a
validation reference and fixture generator.

Original package license: MIT, copyright (c) 2012-2016 Brandon Rhodes.
