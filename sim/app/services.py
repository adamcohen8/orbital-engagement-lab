...
PARAMETER_FORM_SCHEMAS: dict[str, list[dict[str, Any]]] = {
    ...
    "SemiMajorAxisEccentricityController": [
        {"key": "target_a_km", "label": "Target a (km)", "kind": "float"},
        {"key": "target_ecc", "label": "Target Ecc", "kind": "float"},
        {"key": "energy_gain_per_s", "label": "Energy Gain", "kind": "float"},
        {"key": "eccentricity_gain_per_s", "label": "Ecc Gain", "kind": "float"},
        {"key": "max_accel_km_s2", "label": "Max Accel (km/s^2)", "kind": "float"},
        {"key": "a_tolerance_km", "label": "a Tol (km)", "kind": "float"},
        {"key": "ecc_tolerance", "label": "Ecc Tol", "kind": "float"},
    ],
    "OrbitalElementsFeedbackController": [
        {"key": "target_coes", "label": "Target COEs YAML", "kind": "yaml"},
        {"key": "controlled_elements", "label": "Controlled Elements YAML", "kind": "yaml"},
        {"key": "energy_gain_per_s", "label": "Energy Gain", "kind": "float"},
        {"key": "eccentricity_gain_per_s", "label": "Ecc Gain", "kind": "float"},
        {"key": "plane_gain_per_s", "label": "Plane Gain", "kind": "float"},
        {"key": "max_accel_km_s2", "label": "Max Accel (km/s^2)", "kind": "float"},
    ],
        ...
        mission_strategy_options={
            ...
            "chaser": _discover_pointer_options(
                [
                    ...
                    ("COE Station Keep", "sim.mission.modules", "OrbitalElementsStationKeepMissionStrategy"),
                    ("COE Tracking", "sim.mission.modules", "OrbitalElementsTrackingMissionStrategy"),
