...
from sim.control.attitude import ReactionWheelPDController, RICFramePDController
...
class TestRICFramePDController(unittest.TestCase):
    def test_zero_error_and_correct_frame_rate_produce_small_torque(self):
        ...
        self.assertEqual(cmd.mode_flags["mode"], "pd_ric")
